                    ...
                    <div class="row mb-3 mt-4">
                        <div class="col-md-6">
                            <div class="card card-body text-center">
                                ...
                                <p class="mb-0"> <span class="badge text-dark" style="background-color:rgb(255, 147, 163)">Nomor
                                        Pendaftaran</span></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card card-body text-center">
                                ...
                                <p class="mb-0"> <span class="badge text-dark" style="background-color:rgb(255, 147, 163)">Jalur
                                        Pendaftaran
                                    </span> </p>
                            </div>
                        </div>
                                            ...
                                            <div class="">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" name="fcakta" class="custom-file-input"
                                                            id="inputGroupFile01"
                                        ...
                                        <div class="col-sm-4 mt-2">
                                            ...
                                            <div class="">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" name="SKLasli" class="custom-file-input"
                                                            id="inputGroupFile01"
                                        ...
                                        <div class="col-sm-4 mt-2">
                                            ...
                                            <div class="">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" name="fcSTTB" class="custom-file-input"
                                                            id="inputGroupFile01"
                                    ...
                                    <div class="col-sm-4 mt-2">
                                        ...
                                        <div class="">
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" name="suratnarkoba" class="custom-file-input"
                                                        id="inputGroupFile01"
                                    ...
                                    <div class="col-sm-4 mt-2">
                                        ...
                                        <div class="">
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" name="fcKIP" class="custom-file-input"
                                                        id="inputGroupFile01" value="{{ old('fcKIP', $edit->fcKIP) }}">
                                                    <label class="custom-file-label" for="inputGroupFile01">Choose
                                                        file</label>
                                                </div>
                                    ...
                                    <div class="col-sm-4 mt-2">
                                        ...
                                        <div class="">
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" name="fcKPS" class="custom-file-input"
                                                        id="inputGroupFile01" value="{{ old('fcPKH', $edit->fcPKH) }}">
                                                    <label class="custom-file-label" for="inputGroupFile01">Choose
                                                        file</label>
                                                </div>
                                    ...
                                    <div class="col-sm-4 mt-2">
                                        ...
                                        <div class="">
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" name="fcPKH" class="custom-file-input"
                                                        id="inputGroupFile01" value="{{ old('fcPKH', $edit->fcPKH) }}">
                                                    <label class="custom-file-label" for="inputGroupFile01">Choose
                                                        file</label>
                                                </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" name="tingkat" class="form-control" id="tingkat"
                                                value="{{ old('tingkat', $edit->tingkat) }}" placeholder="Cth.Kabupaten">
                                            <div class="invalid-feedback">Isi Dengan benar</div>
                                        </div>
                                        ...
                                        <div class="col-sm-4 mt-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" name="piagam" class="custom-file-input"
                                                            id="inputGroupFile01" value="{{ 'piagam' }}">
                                                        <label class="custom-file-label" for="inputGroupFile01">Choose
                                                            file</label>
                                                    </div>
