                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="date" name="tanggal_lahir_siswa" class="form-control" id="date"
                                            value="{{ old('tanggal_lahir_siswa', $edit->tanggal_lahir_siswa) }}"
                                            placeholder value>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="address" name="tempat_lahir_ibu" class="form-control"
                                            id="address"
                                            value="{{ old('tempat_lahir_ibu', $edit->tempat_lahir_ibu) }}" placeholder
                                            value>
                                        <div class="invalid-feedback">Tempat Lahir Dibutuhkan</div>
                                    </div>
                                    ...
                                    <div class="row g-3">
                                            ...
                                            <div class="input-group">
                                                <div class="form-file">
                                                    <input type="file" class="form-file-input form-control"
                                                        name="fcakta" value="{{ old('fcakta', $edit->fcakta) }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="input-group">
                                                <div class="form-file">
                                                    <input type="file" class="form-file-input form-control"
                                                        name="SKLasli" value="{{ old('SKLasli', $edit->SKLasli) }}">
                                                </div>
                                            </div>
                                            @error('SKLasli')
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="input-group">
                                                <div class="form-file">
                                                    <input type="file" class="form-file-input form-control"
                                                        name="fcSTTB" value="{{ old('fcSTTB', $edit->fcSTTB) }}">
                                                </div>
                                            </div>
                                            @error('fcSTTB')
                                                <div class="alert alert-warning" role="alert">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="input-group">
                                                <div class="form-file">
                                                    <input type="file" class="form-file-input form-control"
                                                        name="fcRaport" value="{{ old('fcRaport', $edit->fcRaport) }}">
                                                </div>
                                            </div>
                                            @error('fcRaport')
                                                <div class="alert alert-warning" role="alert">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="input-group">
                                                <div class="form-file">
                                                    <input type="file" class="form-file-input form-control"
                                                        name="Foto" value="{{ old('Foto', $edit->Foto) }}">
                                                </div>
                                            </div>
                                            @error('Foto')
                                                <div class="alert alert-warning" role="alert">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="input-group">
                                                <div class="form-file">
                                                    <input type="file" class="form-file-input form-control"
                                                        name="fcKIP" value="{{ old('fcKIP', $edit->fcKIP) }}">
                                                </div>
                                            </div>
                                            @error('fcKIP')
                                                <div class="alert alert-warning" role="alert">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="input-group">
                                                <div class="form-file">
                                                    <input type="file" class="form-file-input form-control"
                                                        name="fcKPS" value="{{ old('fcKPS', $edit->fcKPS) }}">
                                                </div>
                                            </div>
                                            @error('fcKPS')
                                                <div class="alert alert-warning" role="alert">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="input-group">
                                                <div class="form-file">
                                                    <input type="file" class="form-file-input form-control"
                                                        name="fcPKH" value="{{ old('fcPKH', $edit->fcPKH) }}">
                                                </div>
                                            </div>
                                            @error('fcPKH')
                                                <div class="alert alert-warning" role="alert">
