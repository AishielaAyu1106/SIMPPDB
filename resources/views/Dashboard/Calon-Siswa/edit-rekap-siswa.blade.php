                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-sm-3">
                                                ...
                                                <input type="text" name="mtk" class="form-control" id="mtk" value="{{ old('mtk' , $editRekap->mtk)}}"
                                                    placeholder="0.00">
                                                <div class="invalid-feedback">Isi Dengan benar</div>
                                            </div>
                                            <div class="col-sm-3">
                                                <label class="form-label">Ilmu Pengetahuan Alam</label>
                                                <input type="text" name="ipa" class="form-control" id="ipa" value="{{ old('ipa' , $editRekap->ipa)}}"
                                                    placeholder="0.00">
                                                <div class="invalid-feedback">Isi Dengan benar</div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input type="text" name="ips" class="form-control" id="ips" value="{{ old('ips' , $editRekap->ips)}}"
                                                    placeholder="0.00">
                                                <div class="invalid-feedback">Isi Dengan benar</div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input type="text" name="basing" class="form-control" id="basing" value="{{ old('basing' , $editRekap->basing)}}"
                                                    placeholder="0.00">
                                                <div class="invalid-feedback">Isi Dengan benar</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" name="jenis_prestasi" class="form-control"
                                                    id="jenisprestasi" value="{{ old('jenis_prestasi' , $editRekap->jenis_prestasi) }}" placeholder="Cth. OSN">
                                                <div class="invalid-feedback">Isi Dengan benar</div>
                                            </div>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" name="nama_prestasi" class="form-control"
                                                    id="nama_prestasi" value="{{ old('nama_prestasi' , $editRekap->nama_prestasi) }}" placeholder="Cth. Olimpiade Sains">
                                                <div class="invalid-feedback">Isi Dengan benar</div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" name="penyelenggara" class="form-control" id="penyelenggara"
                                                    value="{{ old('penyelenggara' , $editRekap->penyelenggara) }}" placeholder="Cth. Kabupaten">
                                                <div class="invalid-feedback">Isi Dengan benar</div>
                                            </div>
                                        ...
                                        <div class="row g-3">
                                            <div class="col">
                                                ...
                                                <div class="input-group">
                                                    <div class="form-file">
                                                        <input type="file" class="form-file-input form-control" value="{{ old('piagam' , $editRekap->piagam) }}"
                                                            name="piagam">
                                                    </div>
                                                </div>
                                            </div>
