...
<head>
    ...
    <link href="{{ asset('bootstrap/dashboard/form-validation.css') }}" rel="stylesheet">
...
<body>
    ...
    @include('Dashboard.Calon-Siswa.Layout.header')

    <div class="container-fluid">
        <div class="row">
            @include('Dashboard.Calon-Siswa.Layout.sidebar')
