<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
    <div class="position-sticky pt-10">
      ...
      <ul class="nav flex-column">
        <li class="nav-item">
          <a class="nav-link {{Request::is('dashboard-siswa') ? 'active' : ''}}" aria-current="page" href="/dashboard-siswa">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle {{Request::is('formulir-pendaftaran-siswa') ? 'active' : ''}}" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="">
            <span data-feather="file-text" class="align-text-bottom"></span>
            Formulir Pendaftaran
          </a>
          <ul class="sub-menu">
            {{-- @if (date('Y-m-d H:i:s') > $afirmasi->tanggal_awal && date('Y-m-d H:i:s') < $afirmasi->tanggal_akhir) --}}
            <a href="/formulir-pendaftaran-siswa/formulir?id=Afirmasi" class="dropdown-item" aria-labelledby="dropdownMenuButton">Afirmasi</a>
            <a href="/formulir-pendaftaran-siswa/formulir?id=Prestasi" class="dropdown-item" aria-labelledby="dropdownMenuButton">Prestasi</a>
            <a href="/formulir-pendaftaran-siswa/formulir?id=Zonasi" class="dropdown-item" aria-labelledby="dropdownMenuButton">Zonasi</a>
            {{-- @endif --}}
