...
@section('container')
    <section style="background-color:white;" class="mt-5">
                    ...
                    <div class="card" style="background-color:rgb(243, 242, 242);">
                        <div class="card-body">
                            ...
                            @elseif ($pengumumansiswa->status == 'Tolak Berkas')
                                <span class="badge text-black badge-primary mb-4" style="background-color:red">Mohon Maaf
                                    Anda Belum Diterima Di SMAN 1 Bengalon</span>
                            @else
                                <span class="badge text-light badge-danger mb-4" style="background-color:blue">Pendaftaran
