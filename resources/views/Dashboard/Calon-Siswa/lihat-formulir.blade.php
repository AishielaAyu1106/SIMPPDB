                    ...
                    <div class="col-lg-4">
                        <div class="card mb-4">
                            <div class="card-body text-center">
                                <img src="{{ asset('css/profile.svg') }}" alt="avatar" class="rounded-circle img-fluid"
                                    style="width: 150px;">
                                ...
                                @if ($lihat->status == 'Berkas Diterima')
                                    <span class="badge text-light badge-primary"
                                        style="background-color:green">Diterima</span>
                                @elseif($lihat->status == 'Berkas Ditolak')
                                    <span class="badge text-black badge-danger" style="background-color:red">Ditolak</span>
                                @else
                                    <span class="badge text-light badge-danger"style="background-color:blue">Sedang
                                        Diproses</span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="card mb-4 sm-lg-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <a href="{{ asset('storage/' . $lihat->piagam) }}"
                                            class="btn btn-outline-success">Lihat
                                            Berkas</a>
                                    </div>
                                </div>
                                <hr>
                        ...
                        <div class="card mb-4 sm-lg-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <a href="{{ asset('storage/' . $lihat->fcakta) }}"
                                            class="btn btn-outline-success">Lihat
                                            Berkas</a>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <a href="{{ asset('storage/' . $lihat->Foto) }}"
                                            class="btn btn-outline-success">Lihat
                                            Berkas</a>
                                    </div>
                                </div>
                        ...
                        <div class="card mb-4 sm-lg-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <a href="{{ asset('storage/' . $lihat->fcKIP) }}"
                                            class="btn btn-outline-success">Lihat
                                            Berkas</a>
                                    </div>
                                </div>
