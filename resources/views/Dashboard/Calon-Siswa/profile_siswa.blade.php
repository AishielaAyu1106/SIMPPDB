                ...
                <div class="card mb-3" style="border-radius: .5rem;">
                    <div class="row g-0">
                        <div class="col-md-4 gradient-custom text-center text-black"
                            style="border-top-left-radius: .5rem; border-bottom-left-radius: .5em; background-color:rgb(255, 243, 245)  ">
                            <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava1-bg.webp"
                                alt="Avatar" class="img-fluid my-5" style="width: 80px;" />
                            <h5>Nama: {{ auth()->user()->name }}</h5>
                            {{-- <p>Jalur Pendaftaran:</p> --}}
                            <a type="submit" href="{{url('profile-siswa-edit')}}" class="btn btn-outline-secondary" data-toggle="modal"
                                data-target="#exampleModal" data-whatever="Tolak Berkas Pendaftaran"><i
                                    class="far fa-edit mb-0"></i>
                            </a>
