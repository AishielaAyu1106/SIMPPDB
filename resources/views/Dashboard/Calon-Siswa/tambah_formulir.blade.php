                            ...
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-sm-6">
                                                <label for="form-label" for="personal-data">Fotocopy Akta
                                                    Kelahiran</label>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-sm-4">
                                                <label for="form-label" for="personal-data">Fotocopy Kartu Indonesia
                                            ...
                                            <div class="col-sm-4">
                                                <label for="form-label" for="personal-data">Fotocopy Kartu Pelindung
                                            ...
                                            <div class="col-sm-4">
                                                <label for="form-label" for="personal-data">Fotocopy Program Keluarga
