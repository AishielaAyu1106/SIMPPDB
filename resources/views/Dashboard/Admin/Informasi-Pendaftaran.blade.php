                ...
                <section class="p-4">
                    <div class="card card-body mt-5 p-4 shadow-sm">
                        <div class="card-body">
                            ...
                            <hr>
                            <small id="passHelper" class="form-text text-muted font-weight-bold">Jika Ingin Mengubah,
                                Silahkan Isi kembali Form Informasi Pendaftaran</small>
                        </div>
                        <div class="card-body">
                                            ...
                                            <td style="width: 200px" class="text-center">
                                                <div class="row">
                                                    <form class="delete-data-swift-allert-example"
                                                        action="/info-pendaftaran/delete/{{ $item->id }}"
                                                        method="post">
                                                        @csrf
                                                        ...
                                                        <button class="col btn btn-outline-danger btn-sm"><i
