        ...
        <div class="container py-5 ">
            ...
            <div class="card">
                <div class="card-body shadow-sm">
                    <h3 class="card-title mb-4 text-dark font-weight-bold" >Data Pendaftaran</h3>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card mb-4">
                            ...
                            <div class="card mb-4 sm-lg-4">
                                <div class="card-body">
                                    <p class="mb-4">
                                    <h6 class="text-primary font-weight-bold me-1">Catatan Prestasi</h6>
                                    </p>
                                    <div class="row">
                                        <div class="col-sm-9">
                            ...
                            <div class="card mb-4 sm-lg-4">
                                <div class="card-body">
                                    <p class="mb-4">
                                    <h6 class="text-primary font-weight-bold me-1">Kelengkapan Berkas</h6>
                                    </p>
                                    <div class="row">
                                        <div class="col-sm-6">
                            ...
                            <div class="card mb-4 sm-lg-4">
                                <div class="card-body">
                                    <p class="mb-4">
                                    <h6 class="text-primary font-weight-bold me-1">Bagi Jalur Afirmasi</h6>
                                    </p>
                                    <div class="row">
                                        <div class="col-sm-6">
                        ...
                        <div class="col-lg-8">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <p class="mb-4">
                                    <h6 class="text-primary font-weight-bold me-1">Biodata Siswa</h6>
                                    </p>
                                    <div class="row">
                                        <div class="col-sm-3">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card mb-3 ">
                                        <div class="card-body">
                                            <p class="mb-4">
                                            <h6 class="text-primary font-weight-bold me-1">Alamat Tempat Tinggal</h6>
                                            </p>
                                            <div class="row">
                                                <div class="col-sm-2">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card mb-4 mb-md-0">
                                        <div class="card-body">
                                            <p class="mb-4">
                                            <h6 class="text-primary font-weight-bold me-1">Data Ayah Kandung</h6>
                                            </p>
                                            <div class="row">
                                                <div class="col-sm-5">
                                ...
                                <div class="col-md-6">
                                    <div class="card mb-4 ">
                                        <div class="card-body">
                                            <p class="mb-4">
                                            <h6 class="text-primary font-weight-bold me-1">Data Ibu Kandung</h6>
                                            </p>
                                            <div class="row">
                                                <div class="col-sm-5">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card mb-3 ">
                                            <div class="card-body">
                                                <p class="mb-4">
                                                <h6 class="text-primary font-weight-bold me-1">Rekap Nilai Semester 1-5</h6>
                                                </p>
                                                <div class="row">
                                                    <div class="col-sm-4">
